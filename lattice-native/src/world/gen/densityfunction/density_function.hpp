...
/// Legacy JVM option hooks retained for loader ABI compatibility. Density
/// AVX-512 is intentionally disabled while its common-path overhead is
/// removed; callers always observe the disabled state.
