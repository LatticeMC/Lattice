...
public final class NativePathfinder {
    ...
    private static final LongAdder WATER_PATH_RESULTS = new LongAdder();
    ...
    public static void recordWaterPathResult() {
        WATER_PATH_RESULTS.increment();
    }
    ...
    public static String stats() {
        ...
        return "attempts=" + attempts
                ...
                + ", waterPath=" + WATER_PATH_RESULTS.sum()
