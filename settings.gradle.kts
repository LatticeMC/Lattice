...
if (!file(".git").exists()) {
    val errorText = """
        ...
        =====================[ ERROR ]=====================
         The Lattice project directory is not a properly cloned Git repository.
         
         In order to build Lattice from source you must clone
...
for (name in listOf("lattice-api", "lattice-server")) {
